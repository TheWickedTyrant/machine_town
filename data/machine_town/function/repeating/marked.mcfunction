...
execute as @s[tag=mtMiner] at @s run function machine_town:blocks/miner/destroy/detection
#place/destroy attacker
execute as @s[tag=mtAttackerPlacer] at @s run function machine_town:blocks/attacker/place/place
execute as @s[tag=mtAttacker] at @s run function machine_town:blocks/attacker/destroy/detection
#place/destroy placer
execute as @s[tag=mtPlacerPlacer] at @s run function machine_town:blocks/placer/place/place
execute as @s[tag=mtPlacer] at @s run function machine_town:blocks/placer/destroy/detection
